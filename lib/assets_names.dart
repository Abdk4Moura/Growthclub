const String iA = 'assets/images';
const String testAppHeroImage = '$iA/1.png';
const String testHomeIcon = '$iA/vector_home_icon.png';
const String testAvatar1 = '$iA/avatar1.png';
...
const List<List<String>> listTiles = [
  [
    'Skill up: Learn a Tech Skill',
    'Peter: Guys can you please help check out...',
    jsAvatar
  ],
  ['Abdullah (Complete Course)', 'Yo!', testAvatar2]
];
