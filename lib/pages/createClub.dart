...
class MoreOptions1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MoreOptions(heading: 'Awesome! Now let\'s\nadd your friends', route: MoreOptions2());
  }
}
...
class MoreOptions2 extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const MoreOptions(heading: 'Progress is best made\ntogether', route: JapaGeng());
  }
}
        ...
        child: Column(
          ...
          children: [
            Column(
              ...
              children: [
                ...
                TextButton(
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.insert_link_outlined, color: GTheme.primaryButtonColor),
            ...
            GrowthronButton(
                ...
                onPressed: () {
                  if (kDebugMode) {
                    print('pushed ${widget.route} whose heading was ${widget.heading}');
                  }
                  setState(() {
                ...
                Column(
                  children: <Widget>[
                    RadioListTile<Modes>(
                      ...
                      title: Text('Private', style: GTheme.bodyText1.copyWith(
                    ...
                    RadioListTile<Modes>(
                      contentPadding: EdgeInsets.zero,
                      title: Text('Public', style: GTheme.bodyText1.copyWith(
                          fontWeight: FontWeight.w300,
                          fontSize: 10
                      )),
                      value: Modes.public,
